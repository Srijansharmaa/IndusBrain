      ...
      <div className="w-full max-w-[760px]">
        ...
        <div className="relative rounded-3xl border border-white/60 bg-white/90 backdrop-blur-xl p-10 shadow-xl">
          ...
          <button
            ...
            onClick={handleLogin}
            className={cx(
              "mt-6 w-full py-3.5 rounded-xl border-none text-sm font-bold transition-all duration-200",
              role && !loading
                ? "bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-lg hover:shadow-xl hover:scale-[1.01] cursor-pointer"
